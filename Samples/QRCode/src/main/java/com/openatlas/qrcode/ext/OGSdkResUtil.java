package com.openatlas.qrcode.ext;
...
public class OGSdkResUtil {
	...
	private OGSdkResUtil(Context paramContext) {
		...
		System.out.println("com.openatlas.qrcode"+"<<<bunny  look "+this.context.getClass().getName());
		try {
			paramContext.getPackageName();
			drawable = Class.forName("com.openatlas.qrcode" + ".R$drawable");
		} catch (ClassNotFoundException localClassNotFoundException1) {
			localClassNotFoundException1.printStackTrace();
		}
		try {
			layout = Class.forName("com.openatlas.qrcode" + ".R$layout");
		...
		try {
			id = Class.forName("com.openatlas.qrcode" + ".R$id");
		...
		try {
			anim = Class.forName("com.openatlas.qrcode" + ".R$anim");
		...
		try {
			style = Class.forName("com.openatlas.qrcode" + ".R$style");
		...
		try {
			string = Class.forName("com.openatlas.qrcode" + ".R$string");
		...
		try {
			array = Class.forName("com.openatlas.qrcode" + ".R$array");
